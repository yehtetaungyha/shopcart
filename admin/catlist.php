...
<body>
	<nav class="navbar navbar-default" role="navigation">
		  <div class="container-fluid div_nav">
		    <div class="navbar-header">
		      <h3 class="header_title">Category List</h3>
		    </div>
		  </div>
	</nav>
	...
	<div class="container">
		<a href="catnew.php" class="btn btn-success add_btn">Add</a>
		<table class="table table-bordered tbl_list">
			...
			<tbody>
				<tr>
					...
					<a class="btn btn-warning " href="catedit.php?id=<?php echo $row ['id'] ?>" role="button">Edit</a>
					<a class="btn btn-danger" href="catdel.php?id=<?php echo $row ['id'] ?>" role="button">Delete</a>
					</td>
				</tr>
					<?php endwhile; ?>
			</tbody>
